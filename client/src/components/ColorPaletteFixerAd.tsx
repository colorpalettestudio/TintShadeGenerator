...
import fixerImage from "@assets/generated_images/color_palette_fixer_interface_43fa74a6.png";
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 md:order-1">
            <img 
              src={fixerImage} 
              alt="Color Palette Fixer interface showing harmony check and smart suggestions"
